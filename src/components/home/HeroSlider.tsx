...
const heroSlides: HeroSlide[] = [
  {
    ...
    descEn: "Boarding, daycare, home sitting, and dog walking from verified hosts across the UAE.",
  ...
  },
  {
    ...
    titleAr: "مركز التبني",
    descEn: "Find your perfect companion from verified adoption listings across the UAE.",
  ...
  },
  {
    ...
    descEn: "Import and export regulations, documents, and guidance for traveling with pets in the UAE.",
  ...
  },
  {
    ...
    titleEn: "Lost & Found",
    titleAr: "المفقودات",
    descEn: "Report missing pets and help reunite lost animals with their families across the UAE.",
