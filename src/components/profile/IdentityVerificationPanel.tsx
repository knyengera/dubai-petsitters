...
export default function IdentityVerificationPanel({ userId, onVerified }: Props) {
  ...
  useEffect(() => {
    if (status === "verified" && !verifiedHandledRef.current) {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-border bg-muted/40 p-5 text-sm text-muted-foreground">
        ...
        Scan the QR code with your phone to photograph your passport or national
        ID and take a quick selfie. Keep this page open — it updates
