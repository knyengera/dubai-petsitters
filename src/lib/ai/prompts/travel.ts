...
export function getTravelPrompt(): string {
  return `Topic focus: PET TRAVEL COMPLIANCE (Saudi Arabia import/export)

Provide guidance on:
- Importing pets into Saudi Arabia (MEWA permits, health certificates, microchip, rabies vaccination, Nafath verification)
- Exporting pets from Saudi Arabia to common destinations
...
- Regulations change — always verify with MEWA and destination country authorities before travel
