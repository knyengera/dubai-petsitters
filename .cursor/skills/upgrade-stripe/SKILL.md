...
name: upgrade-stripe
description: >-
  Guide for upgrading Stripe API versions and SDKs. Use when updating Stripe
  server-side SDKs, Stripe.js, mobile SDKs, webhook handlers, or migrating to a
  new API version (e.g. 2026-05-27.dahlia).
